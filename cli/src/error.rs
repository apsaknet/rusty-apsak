...
use apsak_wallet_core::error::Error as WalletError;
...
pub enum Error {
    ...
    #[error(transparent)]
    WrpcError(#[from] apsak_wrpc_client::error::Error),

    #[error(transparent)]
    RpcError(#[from] apsak_rpc_core::RpcError),
    ...
    #[error(transparent)]
    Daemon(#[from] apsak_daemon::error::Error),
    ...
    #[error(transparent)]
    MetricsError(apsak_metrics_core::error::Error),

    #[error(transparent)]
    ApsakWalletKeys(#[from] apsak_wallet_keys::error::Error),
}
