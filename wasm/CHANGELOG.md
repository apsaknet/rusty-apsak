Latest online documentation available at: https://apsak.aspectron.org/docs/
### Release 2024-04-27
...
- Merge with Rusty apsaK master (0.13.6)
...
- Rename `apsak-beacon` app to `apsak-resolver`
...
- Introduced `Beacon` class that provides connectivity to the community-operated public node infrastructure (backed by `apsak-beacon` load balancer & node status monitor)
...
- Changed documentation structure to use `typedoc` available as a part of redistributables or online at https://apsak.aspectron.org/docs/
