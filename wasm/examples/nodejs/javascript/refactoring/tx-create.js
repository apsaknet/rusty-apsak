...
const apsak = require('../apsak/apsak_wasm');
...
(async () => {
    ...
    //     extraData:[],
    //     payAddress:"apsak:qrwee7xc2qw5whq8qzv82qjld6zunwy46lsy3hueej5kvgfwvamhswy03lsyh"
    // });
    ...
    const addr = address ?? "apsaktest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd";

    const addresses = [
        addr,
        //new Address("apsaktest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd")
    ];
    ...
    // let outputs = [
    //     new apsak.TransactionOutput(300n, new apsak.ScriptPublicKey(0, keypair3.publicKey)),
    //     {
    //         value: 300n,
    //         scriptPublicKey : new apsak.ScriptPublicKey(0, keypair3.publicKey)
    //     },
    // ];
