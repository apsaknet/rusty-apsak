use crate::{
    ...
    handshake::ApsakdHandshake,
    pb::{self, VersionMessage},
    IncomingRoute, ApsakdMessagePayloadType, Router,
};
use apsak_core::{debug, time::unix_now, trace, warn};
use std::sync::Arc;
...
impl EchoFlow {
    pub async fn register(router: Arc<Router>) {
        ...
        let receiver = router.subscribe(vec![
            ApsakdMessagePayloadType::Addresses,
            ApsakdMessagePayloadType::Block,
            ApsakdMessagePayloadType::Transaction,
            ApsakdMessagePayloadType::BlockLocator,
            ApsakdMessagePayloadType::RequestAddresses,
            ApsakdMessagePayloadType::RequestRelayBlocks,
            ApsakdMessagePayloadType::RequestTransactions,
            ApsakdMessagePayloadType::IbdBlock,
            ApsakdMessagePayloadType::InvRelayBlock,
            ApsakdMessagePayloadType::InvTransactions,
            ApsakdMessagePayloadType::Ping,
            ApsakdMessagePayloadType::Pong,
            // ApsakdMessagePayloadType::Verack,
            // ApsakdMessagePayloadType::Version,
            // ApsakdMessagePayloadType::Ready,
            ApsakdMessagePayloadType::TransactionNotFound,
            ApsakdMessagePayloadType::Reject,
            ApsakdMessagePayloadType::PruningPointUtxoSetChunk,
            ApsakdMessagePayloadType::RequestIbdBlocks,
            ...
            ApsakdMessagePayloadType::RequestNextHeaders,
            ApsakdMessagePayloadType::DoneHeaders,
            ApsakdMessagePayloadType::RequestPruningPointUtxoSet,
            ApsakdMessagePayloadType::RequestHeaders,
            ApsakdMessagePayloadType::RequestBlockLocator,
            ApsakdMessagePayloadType::PruningPoints,
            ApsakdMessagePayloadType::RequestPruningPointProof,
            ...
            ApsakdMessagePayloadType::RequestIbdChainBlockLocator,
            ApsakdMessagePayloadType::IbdChainBlockLocator,
            ApsakdMessagePayloadType::RequestAntipast,
    ...
    async fn call(&self, msg: pb::ApsakdMessage) -> bool {
        // echo
...
fn build_dummy_version_message() -> VersionMessage {
    pb::VersionMessage {
        ...
        subnetwork_id: None,
        network: "apsak-mainnet".to_string(),
    }
}
...
impl ConnectionInitializer for EchoFlowInitializer {
    async fn initialize_connection(&self, router: Arc<Router>) -> Result<(), ProtocolError> {
        //
        // Example code to illustrate apsak P2P handshaking
        //
...
mod tests {
    ...
    use apsak_utils::networking::NetAddress;

    #[tokio::test]
    async fn test_handshake() {
        apsak_core::log::try_init_logger("debug");
