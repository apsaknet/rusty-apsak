...
use apsak_p2p_lib::echo::EchoFlowInitializer;
...
async fn main() {
    // [-] - init logger
    apsak_core::log::init_logger(None, "debug");
    ...
    let adaptor = apsak_p2p_lib::Adaptor::bidirectional(ip_port, apsak_p2p_lib::Hub::new(), initializer, Default::default()).unwrap();
    // [1] - connect to a few peers
    let ip_port = String::from("[::1]:17111");
    for i in 0..1 {
