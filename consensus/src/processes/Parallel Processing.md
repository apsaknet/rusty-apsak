...
## Sequential processing flow (in go-apsakd)

Below we detail the current state of affairs in *go-apsakd* and discuss future parallelism opportunities. Processing dependencies between various stages are detailed in square brackets [***deps; type***].
...
The current code design (*go-apsakd*) already logically supports this since the various processing stages were already decoupled for supporting efficient IBD.
