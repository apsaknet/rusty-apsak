...
use apsak_consensus_core::subnets::{self, SubnetworkId};
use apsak_consensus_core::tx::UtxoEntry;
use apsak_txscript::extract_script_pub_key_address;
use apsak_utils::hex::*;
...
impl Transaction {
    ...
    pub fn addresses(&self, network_type: &NetworkTypeT) -> Result<apsak_addresses::AddressArrayT> {
