...
use apsak_hashes::{Hash, ZERO_HASH};
use apsak_muhash::EMPTY_MUHASH;
...
pub const GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        0x27, 0xe5, 0xd7, 0x30, 0x84, 0x79, 0x1b, 0x43,
        0xd7, 0x4a, 0x7d, 0xc4, 0x32, 0xf9, 0x9e, 0xe7,
        0xdb, 0x36, 0xa6, 0x12, 0xc0, 0x11, 0x66, 0x35,
        0xac, 0xcb, 0x86, 0xab, 0x8e, 0xc6, 0x3e, 0xd6,
    ]),
    version: 0,
...
pub const TESTNET_GENESIS: GenesisBlock = GenesisBlock {
    ...
    coinbase_payload: &[
        ...
        0x01,                                                                         // Varint
        0x00,                                                                         // OP-FALSE
        0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x74, 0x65, 0x73, 0x74, 0x6e, 0x65, 0x74, // apsak-testnet
    ],
};
...
pub const SIMNET_GENESIS: GenesisBlock = GenesisBlock {
    ...
    coinbase_payload: &[
        ...
        0x01,                                                                   // Varint
        0x00,                                                                   // OP-FALSE
        0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x73, 0x69, 0x6d, 0x6e, 0x65, 0x74, // apsak-simnet
    ],
};
...
pub const DEVNET_GENESIS: GenesisBlock = GenesisBlock {
    ...
    coinbase_payload: &[
        ...
        0x01,                                                                   // Varint
        0x00,                                                                   // OP-FALSE
        0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x64, 0x65, 0x76, 0x6e, 0x65, 0x74, // apsak-devnet
    ],
};
...
mod tests {
    ...
    fn gen_testnet11_genesis() {
        ...
        let target = apsak_math::Uint256::from_compact_target_bits(genesis.bits);
