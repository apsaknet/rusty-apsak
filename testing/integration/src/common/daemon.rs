...
use apsak_core::{core::Core, signals::Shutdown, task::runtime::AsyncRuntime};
...
use apsak_rpc_core::notify::mode::NotificationMode;
use apsak_rpc_service::service::RpcCoreService;
use apsak_utils::triggers::Listener;
use apsakd_lib::{args::Args, daemon::create_core_with_runtime};
use parking_lot::RwLock;
use std::{ops::Deref, sync::Arc, time::Duration};
use tempfile::TempDir;

use apsak_grpc_client::ClientPool;
...
impl Daemon {
    ...
    pub fn with_manager(client_manager: Arc<ClientManager>, fd_total_budget: i32) -> Daemon {
        let appdir_tempdir = get_apsak_tempdir();
