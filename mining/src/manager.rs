...
use apsak_consensusmanager::{spawn_blocking, ConsensusProxy};
use apsak_core::{debug, error, info, time::Stopwatch, warn};
use apsak_mining_errors::{manager::MiningManagerError, mempool::RuleError};
                ...
                Err(BuilderError::ConsensusError(BlockRuleError::InvalidTransactionsInNewBlock(invalid_transactions))) => {
                    ...
                    invalid_transactions.iter().for_each(|(x, err)| {
                        ...
                        if let Err(err) = removal_result {
                            ...
                            // https://github.com/apsaknet/apsakd/issues/1553
