...
/// This class accepts the master apsaK XPrv string (e.g. `xprv1...`) and generates
...
///
/// Please note that in apsaK master private keys use `kprv` prefix.
///
