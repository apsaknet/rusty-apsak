...
use crate::imports::*;
use apsak_consensus_client::{TransactionOutput, TransactionOutputInner};
...
export interface IPaymentOutput {
     ...
     * you are transacting on (e.g. `apsak:` for mainnet, `apsaktest:` for testnet, etc).
     */
    address: Address | string;
    /**
     * Output amount in IPMOS.
     */
    amount: bigint;
}
"#;
