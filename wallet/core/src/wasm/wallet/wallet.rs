...
use apsak_wrpc_wasm::{IConnectOptions, Resolver, RpcClient, RpcConfig, WrpcEncoding};
...
///
/// The Rusty apsaK is developed in Rust, and the Wallet class is a Rust implementation
