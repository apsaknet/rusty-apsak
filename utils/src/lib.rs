...
/// #[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
/// struct TestStruct {
///     #[serde(with = "apsak_utils::serde_bytes_fixed")]
///     v: [u8; 20],
/// }
...
///     }
/// }
/// impl apsak_utils::hex::FromHex for MyStruct {
...
///     }
/// }
/// apsak_utils::serde_impl_ser_fixed_bytes_ref!(MyStruct, 20);
/// apsak_utils::serde_impl_deser_fixed_bytes_ref!(MyStruct, 20);
///
...
/// #[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
/// struct TestStruct {
///     #[serde(with = "apsak_utils::serde_bytes_fixed_ref")]
///     v: MyStruct,
/// }
///
