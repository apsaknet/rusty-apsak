...
use apsak_consensus_notify::notification::{self as consensus_notify, Notification as ConsensusNotification};
use apsak_consensusmanager::{ConsensusManager, ConsensusProxy};
use apsak_math::Uint256;
use apsak_mining::model::{owner_txs::OwnerTransactions, TransactionIdSet};
use apsak_notify::converter::Converter;
use apsak_rpc_core::{
...
use apsak_txscript::{extract_script_pub_key_address, script_class::ScriptClass};
...
impl ConsensusConverter {
    ...
    ///
    /// _GO-APSAKD: PopulateBlockWithVerboseData_
    ...
    ///
    /// _GO-APSAKD: PopulateTransactionWithVerboseData
