use crate::{
    error::{Error, Result},
    resolver::{ApsakdResponseReceiver, ApsakdResponseSender, Resolver},
};
...
impl Pending {
    fn new(sender: ApsakdResponseSender) -> Self {
...
impl Resolver for IdResolver {
    fn register_request(&self, _: ApsakdPayloadOps, request: &ApsakdRequest) -> ApsakdResponseReceiver {
