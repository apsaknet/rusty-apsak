use crate::protowire::{apsakd_request::Payload as RequestPayload, apsakd_response::Payload as ResponsePayload, *};
...
pub enum ApsakdPayloadOps {
    ...
    // The conversion from a notification ResponsePayload into ApsakdPayloadOps fails.
}
}
