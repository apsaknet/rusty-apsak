...
pub enum RpcApiOps {
    ...
    GetSyncStatus,
    /// Returns the network this Apsakd is connected to (Mainnet, Testnet)
    GetCurrentNetwork,
    ...
    GetBlockTemplate,
    /// Returns a list of all the addresses (IP, port) this Apsakd knows and a list of all addresses that are currently banned by this Apsakd
    GetPeerAddresses,
    ...
    GetMempoolEntries,
    /// Returns a list of the peers currently connected to this Apsakd, along with some statistics on them
    GetConnectedPeerInfo,
    /// Instructs Apsakd to connect to a given IP address.
    AddPeer,
